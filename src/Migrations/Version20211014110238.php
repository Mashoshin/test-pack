...
final class Version20211014110238 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('SELECT setval(\'track_result_id_seq\', (SELECT MAX(id) FROM track_result))');
        $this->addSql('ALTER TABLE track_result ALTER id SET DEFAULT nextval(\'track_result_id_seq\')');
    }
